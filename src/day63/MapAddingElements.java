...
public class MapAddingElements {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(nameAgePair.get("Fatih"));
        System.out.println(nameAgePair.containsKey("Fatih"));


        Map<String,Double> nameGroceryAndPrice = new HashMap<>();
        nameAgePair.put("Tomato",7);
        nameAgePair.put("Apple",5);
        nameAgePair.put("Carrot",3);
        nameAgePair.put("Orange",5);
        nameAgePair.put("Apple",5);
        nameAgePair.put("Tomato",7);
        nameAgePair.put("Nuts",12);
        System.out.println(nameGroceryAndPrice.size());
    }
}
