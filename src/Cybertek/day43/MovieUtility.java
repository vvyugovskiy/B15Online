...
public class MovieUtility {
    public static void main(String[] args) {
        ...
        String longest = getLongestMovieName(myMovieList);
    ...
    public static List<Movie> getMyFavoriteMovies() {
        ...
        //TODO YOUR CODE HERE
        movieLst.add(new Movie("Life Is Beautiful",1.55,"Drama"));
        movieLst.add(new Movie("Ghost",2.1,"Drama"));
        movieLst.add(new Movie("Sweet November",2.0,"Romance"));
        movieLst.add(new Movie("Delivery Man",1.45,"Comedy"));
        movieLst.add(new Movie("Fight Club",2.2,"Drama"));
        movieLst.add(new Movie("Forrest Gump",2.25, "Drama"));
        movieLst.add(new Movie("RED",1.50,"Comedy"));
        movieLst.add(new Movie("The Fifth Element",2.1,"Action"));
        return movieLst;
    }
    /**
