...
public class IndexWith2Parameters {
    public static void main(String[] args) {
        ...
        System.out.println(name.indexOf("Cybertek"));
        System.out.println(name.indexOf("Cybertek",name.indexOf("Cybertek")+1));

        int firstJavaLocation = name.indexOf("Cybertek"); // location of first Java

        int startingPointToSearchSecondJava = firstJavaLocation+1;
        int secondJavaLocation = name.indexOf("Cybertek",startingPointToSearchSecondJava);
