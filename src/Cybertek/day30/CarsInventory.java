...
//                countCV++;
//            }
//            if (car.contains("Civic")) {
//                countCiv++;
//            }
//        }
//        System.out.println("Chevrolet : " + countCV + " and " + countCiv + " Civic");
        // Using for loop
        ...
        System.out.println(Arrays.toString(eachCarSplitted));

        //  find all the car with model has only 2 characters
        // print them out
        // get the count
        int count2 = 0;
        for (String eachCar1 : cars) {
            String[] afterSplit = eachCar1.split("-");
            if (afterSplit.length == 2) {
                if (afterSplit[1].length() == 3) {
                    count2++;
                    System.out.println(eachCar1);
        ...
        Arrays.sort(cars);
        System.out.print("Sorted cars : "+Arrays.toString(cars));
    }
}
